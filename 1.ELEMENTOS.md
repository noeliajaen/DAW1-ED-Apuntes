...
Predictivos: planificado todo hasta el último detalle.
Modelos evolutivos: no estan definidos al 100% como los modelos clasicos.
...
Es muy rígido,pasas de una fase a la siguiente sin poder volver atrás, usado en app pequeñas.
...
Parecido al anterior, / VALIDAR: que se está haciendo el producto que pide el cliente (correcto) el ¿que se hace?

VERIFICAR: q se esta haciendl el producto de forma correcta, segun el diseño que hemos creado. el ?como se hace?
